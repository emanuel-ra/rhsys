...
<body>
    ...
    <div style="text-align: justify;">
        ...
        <b>CONTRATO INDIVIDUAL DE TRABAJO POR TIEMPO INDETERMINADO CON PERIODO DE PRUEBA</b>, QUE SE CELEBRA CONFORME A LO ESTABLECIDO EN LOS ARTÍCULOS 25, 39-A, 39-C, 39-D, Y 39-E, DE LA LEY FEDERAL DEL TRABAJO REFORMADA EL DIA 30 DE NOVIEMBRE DE 2012, QUE CELEBRAN POR UNA PARTE LA SOCIEDAD MERCANTIL DENOMINADA <b>{{strtoupper($Company->business_name)}}</b> A TRAVES DE SU APODERADO LEGAL EL/LA {{strtoupper($Company->legal_representative)}}, A QUIEN EN LO SUCESIVO SE LE DENOMINARA “EL PATRON” Y POR LA OTRA PARTE EL(A) SEÑOR(A) C. <b>{{strtoupper($data->name)}}</b>, A QUIEN EN LO SUCESIVO SE LE DENOMINARA “LA TRABAJADORA” QUIENES CELEBRAN EL PRESENTE CONTRATO CONFORME A LAS DECLARACIONES Y CLÁUSULAS, SIGUIENTES:
    </div>
    ...
    <ol class="declarations">
        ...
        <li>
            ...
            <ol class="sub_declarations">
                <li>
                    El trabajador declara llamarse <b>{{strtoupper($data->name)}}</b> y bajo protesta de decir verdad declara tener la capacidad legal, para los efectos legales a que haya lugar.
                </li>
            </ol>
            <br>
    ...
    <p style="text-align: justify;">
        <b>PRIMERA.</b>-  La duración del presente contrato será por un PERIODO INDETERMINADO CON PERIODO APRUEBA DE TREINTA DÍAS en virtud de que “EL TRABAJADOR” no cuenta con los requisitos, conocimientos y la preparación suficiente para desempeñar el trabajo para el cual fue contratado y dicho contrato no podrá ser reformado, adicionado o terminado, sino por voluntad de las partes o por las causas previstas en la ley. </b>.
    </p>

    <p style="text-align: justify;">
        <b>SEGUNDA.</b>- Toda vez que el trabajo para el cual se contrata a “EL TRABAJADOR” dada la función que desempeñara requiere tener conocimientos profesionales especializados sobre la ________________(FINALIDAD DEL PUESTO)____________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________, es por tal razón que “EL TRABAJADOR” estará sujeto a un periodo de prueba, el cual dará inicio desde la firma del presente contrato y concluirá treinta días naturales posteriores a que dé inicio. Bajo el supuesto de que al término del periodo de prueba “EL TRABAJADOR” no acredite satisfacer los requisitos y conocimientos necesarios para desarrollar las labores para las que se le contrata, a juicio de “EL PATRON” para tal efecto de realizar un examen el último día del periodo de capacitación el cual deberá de ser aprobado por “EL TRABAJADOR” con una calificación mínima a de noventa sobre cien y tomando en cuenta  la opinión de la COMISION MIXTA DE PRODUCTIVIDAD, CAPACITACION Y ADIESTRAMIENTO, en los términos de ley, así como la naturaleza del puesto, se dará por terminada la relación  de trabajo, sin responsabilidad  para “EL PATRON”, de conformidad con los artículos 39 A, 39C, 39D, de la Ley Federal del Trabajo.
    </p>
    
    <p style="text-align: justify;">
        <b>TERCERA.</b>- El presente contrato tendrá la duración de un periodo que se contara a partir de la firma del presente contrato, es decir, del <b>{{ \Carbon\Carbon::parse($data->hired_date)->formatLocalized('%d de %B %Y') }}</b> Y <b>{{ ($data->expiration_date=='') ? 'Indeterminado' : \Carbon\Carbon::parse($data->expiration_date)->formatLocalized('%d de %B %Y')  }}</b>; en virtud de así exigirlo la naturaleza del trabajo que se desempeñara, señalado en la cláusula anterior, o bien cuando se termine la actividad objeto del presente contrato, lo que acontezca primero. Al termino establecido, concluirá la relación de trabajo, sin responsabilidad del patrón. 
    </p>
    ...
    <p style="text-align: justify;">SEXTA.- Ambas partes están de acuerdo que “EL TRABAJADOR” tiene estrictamente prohibido trabajar jornada extraordinaria y solo podrá laborar en tiempo extraordinario con autorización expresa y por escrito de la parte patronal.</p>

    <p style="text-align: justify;">SEPTIMA.- Ambas partes están de acuerdo que “EL TRABAJADOR”  hará constar cada día su asistencia mediante la firma del libro de asistencias, checador electrónico o similar; el incumplimiento de tal requisito se considera falta de asistencia para los efectos conducentes. </p>

    <p style="text-align: justify;">OCTAVA.- “ EL TRABAJADOR” disfrutará de descanso con pago de salario íntegro los días a que se refiere el artículo 74 de la Ley Federal del Trabajo en vigor. </p>

    <p style="text-align: justify;">NOVENA.- “EL TRABAJADOR” disfrutará de los días de descanso obligatorio y vacaciones, conforme a lo dispuesto en los artículos 76, 78, 79,80 y 81 de la Ley Federal Del Trabajo en vigor. Recibirá una prima vacacional equivalente al 25%del importe pagado por concepto de vacaciones. Asimismo, “EL TRABAJADOR” percibirá un aguinaldo anual equivalente a 15 días de salario, que le será pagado conforme al artículo 87 del ordenamiento en cita, a más tardar el 19 de diciembre de cada año.</p>

    <p style="text-align: justify;">DECIMA.- Ambas partes están de acuerdo que para garantizar la Seguridad Social de “EL TRABAJADOR”, “EL PATRON”, a partir de la firma del presente contrato, estará obligado a inscribir ante el Instituto Mexicano Del Seguro Social a “EL TRABAJADOR”, como su trabajador aun estando dicha persona en periodo a prueba. </p>

    <p style="text-align: justify;">DECIMA PRIMERA.- “EL TRABAJADOR” acepta someterse a los exámenes médicos que periódicamente establezca “EL PATRÓN” en los términos del artículo 134 de “LA LEY”, a fin de mantener en forma óptima sus facultades físicas e intelectuales, para el mejor desempeño de sus funciones. El médico que practique los reconocimientos será designado y retribuido por “EL PATRON”. </p>
    ...
    <p style="text-align: justify;">DECIMA TERCERA.- “EL TRABAJADOR” acepta que cuando por razones convenientes para “EL PATRON”, éste modifique el horario de trabajo, día de descanso, actividad o departamento, deberá desempeñar su jornada en el que quede establecido, ya que sus actividades al servicio de “EL PATRON” son prioritarias y no se contraponen a otras que pudieran llegar a desarrollar. </p>

    <p style="text-align: justify;">DECIMA CUARTA.- “EL TRABAJADOR” deberá dar fiel cumplimiento a las disposiciones contenidas en el artículo 134 de “ LA LEY” y que corresponden a las obligaciones de los trabajadores en el desempeño de sus labores al servicio de “ EL PATRÓN”. </p>

    <p style="text-align: justify;">DECIMA QUINTA.- “ EL TRABAJADOR” deberá presentarse puntualmente a sus labores en el horario de trabajo establecido y firmar las listas de asistencia acostumbradas o checar su tarjeta de asistencia mediante reloj checador diariamente. En caso de retraso o falta de asistencia injustificada, será potestativo para “EL PATRÓN” admitirlo, y si lo hace cubrirá únicamente el tiempo efectivo de trabajo desarrollado. </p>

    <p style="text-align: justify;">DECIMA SEXTA.-  Se conviene que “EL TRABAJADOR” tiene derecho a recibir ingresos por concepto de previsión social, de acuerdo al Plan de Previsión Social de “EL PATRON”, los cuales no se encuentran limitados de forma alguna, y están exentos al pago de impuesto sobre la renta. </p>

    <p style="text-align: justify;">DECIMA SEPTIMA.- Ambas partes convienen que en lo no previsto en este contrato se aplicara lo dispuesto por la Ley Federal del Trabajo, del Reglamento Interior de Trabajo, y las demás correlativas y aplicables, cancelando y dejando sin efectos cualquier otro acuerdo verbal o escrito, que las partes pudieran haber celebrado con anterioridad, sometiéndose la pates a lo dispuesto por la Junta Local de Conciliación y Arbitraje de Jalisco, para el caso de controversia, por tal razón las partes renuncian a la competencia de cualquier otra junta por razón de lugar en donde se presten los servicios al final de la relación laboral. </p>
