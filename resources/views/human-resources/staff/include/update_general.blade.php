<div class="col-sm-12 col-md-2">
    <x-dg-input type="text" label="Clave" name="code" maxlength="20" value="{{ $Staff->code }}" placeholder=""  />
</div>
<div class="col-sm-12 col-md-2">
    <x-dg-input type="text" label="Clave Checador" name="checker_code" maxlength="20" value="{{ $Staff->checker_code }}" placeholder=""  />
</div>

<div class="col-sm-12 col-md-8">
    <x-dg-input type="text" label="Nombre" name="name" maxlength="255" value="{{ $Staff->name }}" placeholder=""  />
</div>
...
<div class="col-sm-12 col-lg-6 col-xl-4">
    <x-dg-input type="text" label="CURP" name="curp" maxlength="255" value="{{ $Staff->curp }}" placeholder=""  />
</div>

<div class="col-sm-12 col-lg-6 col-xl-4">
    <x-dg-input type="text" label="RFC" name="rfc" maxlength="255" value="{{ $Staff->rfc }}" placeholder="" />
</div>

<div class="col-sm-12 col-lg-6 col-xl-4">
    <x-dg-input type="text" label="Número de Seguro Social" name="nss" maxlength="255" value="{{ $Staff->nss }}" placeholder="" />
</div>

<div class="col-sm-12 col-lg-6 col-xl-4">
    <x-dg-input type="text" label="Cuenta Bancaria" name="bank_account" maxlength="255" value="{{ $Staff->bank_account }}" placeholder="" />
</div>
...
<div class="col-sm-12 col-lg-6 col-xl-4 form-group">
    ...
    <select id="company_id" name="company_id" class="form-control"  onchange="GetBranches(this.value,'{{ csrf_token() }}','branch_id','{{ url('') }}')">        
        ...
        @foreach ($Company as $item)
            <option {{ ($Staff->company_id ==$item->id) ? 'selected':''; }} value="{{ $item->id }}">{{ $item->name }}</option>
        @endforeach
    </select>
</div>
...
<div class="col-sm-12 col-lg-6 col-xl-3">
    <x-dg-select id="scholarship_id" name="scholarship_id" label="Escolaridad" inputclass="form-select" >        
        ...
        <option {{ ($Staff->scholarship_id==$item->id) ? 'selected':''; }} value="{{ $item->id }}">{{ $item->name }}</option>
        @endforeach
    </x-dg-select>
</div>
...
<div class="col-sm-12 col-md-2">
    <x-dg-input-date id="hired_date" name="hired_date" label="Fecha ingreso" value="{{$Staff->hired_date}}"  />
</div>
...
<div class="col-sm-12 col-md-3">
    ...
    <div class="form-check">
        <input class="form-check-input" type="radio" name="socioeconomic" id="socioeconomic_no" value="0" {{ (!$Staff->socioeconomic) ? 'checked':''; }}>
...
<div class="col-sm-12 col-md-3">
    ...
    <div class="form-check">
        <input class="form-check-input" type="radio" name="genre" id="female" value="Femenino" {{ ($Staff->genre=='Femenino') ? 'checked':''; }}>
