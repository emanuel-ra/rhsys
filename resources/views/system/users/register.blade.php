    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('system.users.store') }}" method="POST">
                ...
                <div class="col-sm-12">
                    <x-dg-input type="text" label="Nombre de Usuario" name="name" maxlength="255" value="{{old('name')}}" placeholder="Capture el nombre del usuario" required />
                </div>

                <div class="col-sm-12">
                    <x-dg-input type="email" label="Nombre del email" name="email" maxlength="255" value="{{old('email')}}" placeholder="Capture el email del usuario" required />
                </div>


                <div class="col-sm-12">
                    <x-dg-input type="password" label="Nombre su contraseña" name="password" maxlength="255" placeholder="Capture una contraseña valida contraseña" required />
                </div>


                <div class="col-sm-12">
                    <x-dg-input type="password" label="Confirme su contraseña" name="cpassword" maxlength="255" placeholder="Confirme su contraseña" required />
                </div>
