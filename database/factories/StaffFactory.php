...
class StaffFactory extends Factory
{
    ...
    public function definition($is_supervisor=0)
    {
        ...
        return [
            ...
            'chields_name' => $this->faker->name() , 
            'name_person_emergency' => $this->faker->name() , 
            ...
            'landline_emergency_phone' => $this->faker->phoneNumber() ,
            'mobile_emergency_phone' => $this->faker->phoneNumber() ,
